...
import com.eou.gameapp.databinding.FragmentThirdBlankBinding
 ...
 * This class is the third fragment and it is for the game instruction page
 *
...
class ThirdBlankFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.back2.setOnClickListener{
            navController.navigate(R.id.action_thirdBlankFragment_to_firstBlankFragment)
        }
    }
